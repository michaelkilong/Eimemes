...
export default async function ArticlePage({ params }: Props) {
  ...
  return (
    <>
      <Header />
      <main>
        {/* Hero — stronger gradient overlay for readability */}
        ...
        {/* Article body — no extra wrapper, white background from body */}
        ...
        {/* Related articles — white background from body, no separate bg */}
        {related.length > 0 && (
          <div className="border-t border-[#e5e0d8] py-16">
